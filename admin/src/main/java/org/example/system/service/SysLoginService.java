...
public class SysLoginService {
    ...
    public void register(String username, String password) {
        ...
        if (!("true".equals(sysConfigService.selectConfigByKey("sys.account.registerUser")))) {
            throw new ServiceException("The current system does not have the registration function enabled");
        }
        if (!sysUserService.checkUserNameUnique(sysUser)) {
            throw new ServiceException("Failed, registered account already exists");
        }
        ...
        recordLogService.recordLogininfor(username, Constants.REGISTER, "login was successful");
    }
}
