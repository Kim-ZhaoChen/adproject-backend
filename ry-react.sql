...
VALUES (1, 'test', 'test', NULL, NULL, 'Test', 'crud', '', 'com.example', 'example', 'test', 'test', 'louis', '0', '/',
        NULL, 'admin', '2024-04-13 13:22:26', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
INSERT INTO `gen_table_column`
VALUES (1, 1, 'id', NULL, 'int(11)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin',
        '2024-04-13 13:22:29', '', NULL);
INSERT INTO `gen_table_column`
VALUES (2, 1, 'name', NULL, 'varchar(255)', 'String', 'name', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '',
        2, 'admin', '2024-04-13 13:22:29', '', NULL);
...
VALUES (1, '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'Y', 'admin', '2024-04-12 22:06:26', '',
        NULL, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow');
INSERT INTO `sys_config`
VALUES (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', '2024-04-12 22:06:26', '', NULL,
        '初始化密码 123456');
INSERT INTO `sys_config`
VALUES (3, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'Y', 'admin', '2024-04-12 22:06:26', '', NULL,
        '深色主题theme-dark，浅色主题theme-light');
INSERT INTO `sys_config`
VALUES (4, '账号自助-验证码开关', 'sys.account.captchaEnabled', 'true', 'Y', 'admin', '2024-04-12 22:06:26', '', NULL,
        '是否开启验证码功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2024-04-12 22:06:26',
        '', NULL, '是否开启注册用户功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (6, '用户登录-黑名单列表', 'sys.login.blackIPList', '', 'Y', 'admin', '2024-04-12 22:06:26', '', NULL,
...
VALUES (100, 0, '0', 'wewalk科技', 0, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2024-04-12 22:06:26',
        '', NULL);
INSERT INTO `sys_dept`
VALUES (101, 100, '0,100', '深圳总公司', 1, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (102, 100, '0,100', '长沙分公司', 2, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (103, 101, '0,100,101', '研发部门', 1, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (104, 101, '0,100,101', '市场部门', 2, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (105, 101, '0,100,101', '测试部门', 3, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (106, 101, '0,100,101', '财务部门', 4, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (107, 101, '0,100,101', '运维部门', 5, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (108, 102, '0,100,102', '市场部门', 1, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
INSERT INTO `sys_dept`
VALUES (109, 102, '0,100,102', '财务部门', 2, 'wewalk', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2024-04-12 22:06:26', '', NULL);
...
VALUES (1, 1, '男', '0', 'sys_user_sex', '', '', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '性别男');
INSERT INTO `sys_dict_data`
VALUES (2, 2, '女', '1', 'sys_user_sex', '', '', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '性别女');
INSERT INTO `sys_dict_data`
VALUES (3, 3, '未知', '2', 'sys_user_sex', '', '', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '性别未知');
INSERT INTO `sys_dict_data`
VALUES (4, 1, '显示', '0', 'sys_show_hide', '', 'primary', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '显示菜单');
INSERT INTO `sys_dict_data`
VALUES (5, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '隐藏菜单');
INSERT INTO `sys_dict_data`
VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (8, 1, '正常', '0', 'sys_job_status', '', 'primary', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (9, 2, '暂停', '1', 'sys_job_status', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (10, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '默认分组');
INSERT INTO `sys_dict_data`
VALUES (11, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '系统分组');
INSERT INTO `sys_dict_data`
VALUES (12, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '系统默认是');
INSERT INTO `sys_dict_data`
VALUES (13, 2, '否', 'N', 'sys_yes_no', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '系统默认否');
INSERT INTO `sys_dict_data`
VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '通知');
INSERT INTO `sys_dict_data`
VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '公告');
INSERT INTO `sys_dict_data`
VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '关闭状态');
INSERT INTO `sys_dict_data`
VALUES (18, 99, '其他', '0', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '其他操作');
INSERT INTO `sys_dict_data`
VALUES (19, 1, '新增', '1', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '新增操作');
INSERT INTO `sys_dict_data`
VALUES (20, 2, '修改', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '修改操作');
INSERT INTO `sys_dict_data`
VALUES (21, 3, '删除', '3', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '删除操作');
INSERT INTO `sys_dict_data`
VALUES (22, 4, '授权', '4', 'sys_oper_type', '', 'primary', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '授权操作');
INSERT INTO `sys_dict_data`
VALUES (23, 5, '导出', '5', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '导出操作');
INSERT INTO `sys_dict_data`
VALUES (24, 6, '导入', '6', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '导入操作');
INSERT INTO `sys_dict_data`
VALUES (25, 7, '强退', '7', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '强退操作');
INSERT INTO `sys_dict_data`
VALUES (26, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '生成操作');
INSERT INTO `sys_dict_data`
VALUES (27, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '清空操作');
INSERT INTO `sys_dict_data`
VALUES (28, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (29, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 'admin', '2024-04-12 22:06:26', '', NULL,
        '停用状态');
...
VALUES (1, '用户性别', 'sys_user_sex', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '用户性别列表');
INSERT INTO `sys_dict_type`
VALUES (2, '菜单状态', 'sys_show_hide', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '菜单状态列表');
INSERT INTO `sys_dict_type`
VALUES (3, '系统开关', 'sys_normal_disable', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '系统开关列表');
INSERT INTO `sys_dict_type`
VALUES (4, '任务状态', 'sys_job_status', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '任务状态列表');
INSERT INTO `sys_dict_type`
VALUES (5, '任务分组', 'sys_job_group', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '任务分组列表');
INSERT INTO `sys_dict_type`
VALUES (6, '系统是否', 'sys_yes_no', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '系统是否列表');
INSERT INTO `sys_dict_type`
VALUES (7, '通知类型', 'sys_notice_type', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '通知类型列表');
INSERT INTO `sys_dict_type`
VALUES (8, '通知状态', 'sys_notice_status', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '通知状态列表');
INSERT INTO `sys_dict_type`
VALUES (9, '操作类型', 'sys_oper_type', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '操作类型列表');
INSERT INTO `sys_dict_type`
VALUES (10, '系统状态', 'sys_common_status', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '登录状态列表');
...
VALUES (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?',
        '3', '1', '1', 'admin', '2024-04-12 22:06:26', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_logininfor
-- ----------------------------
INSERT INTO `sys_logininfor`
VALUES (1, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 11:41:41');
INSERT INTO `sys_logininfor`
VALUES (2, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 11:47:12');
INSERT INTO `sys_logininfor`
VALUES (3, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:04:55');
INSERT INTO `sys_logininfor`
VALUES (4, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:05:37');
INSERT INTO `sys_logininfor`
VALUES (5, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:06:25');
INSERT INTO `sys_logininfor`
VALUES (6, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:07:46');
INSERT INTO `sys_logininfor`
VALUES (7, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:08:21');
INSERT INTO `sys_logininfor`
VALUES (8, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:13:45');
INSERT INTO `sys_logininfor`
VALUES (9, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:15:18');
INSERT INTO `sys_logininfor`
VALUES (10, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:17:49');
INSERT INTO `sys_logininfor`
VALUES (11, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:19:49');
INSERT INTO `sys_logininfor`
VALUES (12, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:26:35');
INSERT INTO `sys_logininfor`
VALUES (13, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-04-13 12:28:36');
INSERT INTO `sys_logininfor`
VALUES (14, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-07-30 15:36:32');
INSERT INTO `sys_logininfor`
VALUES (15, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-07-31 08:58:59');
INSERT INTO `sys_logininfor`
VALUES (16, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-07-31 14:24:23');
INSERT INTO `sys_logininfor`
VALUES (17, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-07-31 14:27:56');
INSERT INTO `sys_logininfor`
VALUES (18, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-08-01 11:02:38');
INSERT INTO `sys_logininfor`
VALUES (19, 'admin', '127.0.0.1', NULL, NULL, NULL, '1', '密码输入错误1次', '2024-08-04 05:56:14');
INSERT INTO `sys_logininfor`
VALUES (20, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-08-04 06:00:08');
INSERT INTO `sys_logininfor`
VALUES (21, NULL, '127.0.0.1', NULL, NULL, NULL, '1', '用户/密码必须填写', '2024-08-06 10:32:25');
INSERT INTO `sys_logininfor`
VALUES (22, NULL, '127.0.0.1', NULL, NULL, NULL, '1', '用户/密码必须填写', '2024-08-06 10:32:55');
INSERT INTO `sys_logininfor`
VALUES (23, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-08-06 10:32:58');
INSERT INTO `sys_logininfor`
VALUES (24, 'admin123', '127.0.0.1', NULL, NULL, NULL, '0', '注册成功', '2024-08-06 11:15:03');
...
VALUES (1, '温馨提醒：2018-07-01 wewalk新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin',
        '2024-04-12 22:06:26', '', NULL, '管理员');
INSERT INTO `sys_notice`
VALUES (2, '维护通知：2018-07-01 wewalk系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin',
        '2024-04-12 22:06:26', '', NULL, '管理员');
...
VALUES (1, 'ceo', '董事长', 1, '0', 'admin', '2024-04-12 22:06:26', '', NULL, '');
INSERT INTO `sys_post`
VALUES (2, 'se', '项目经理', 2, '0', 'admin', '2024-04-12 22:06:26', '', NULL, '');
INSERT INTO `sys_post`
VALUES (3, 'hr', '人力资源', 3, '0', 'admin', '2024-04-12 22:06:26', '', NULL, '');
INSERT INTO `sys_post`
VALUES (4, 'user', '普通员工', 4, '0', 'admin', '2024-04-12 22:06:26', '', NULL, '');
...
VALUES (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '超级管理员');
INSERT INTO `sys_role`
VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2024-04-12 22:06:26', '', NULL, '普通角色');
...
VALUES (1, 103, 'admin', 'wewalk', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$y/tEtPAb1n3riS/LeUZH/OLV8yjR/wgsl47T8Zr6VLR1ig3ZezH3W', '0', '0', '127.0.0.1', '2024-04-12 22:06:26',
        'admin', '2024-04-12 22:06:26', '', NULL, '管理员');
INSERT INTO `sys_user`
VALUES (2, 105, 'ry', 'wewalk', '00', 'ry@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-04-12 22:06:26',
        'admin', '2024-04-12 22:06:26', '', NULL, '测试员');
INSERT INTO `sys_user`
VALUES (3, NULL, 'admin123', 'admin123', '00', '', '', '0', '',
        '$2a$10$CnR9ikNBe6EylZRo/aODt.u.RdJHwHKZG2Z/LqvzAqV1s//t5TS1i', '0', '0', '', NULL, '', '2024-08-06 11:15:03',
        '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'test' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for walking_steps_history
-- ----------------------------
DROP TABLE IF EXISTS `walking_steps_history`;
CREATE TABLE `walking_steps_history`
(
    `id`          varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主键ID',
    `steps`       bigint NULL DEFAULT NULL COMMENT '步数',
    `user_id`     varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关联用户表id',
    `del_flag`    char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
    `create_by`   varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
    `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
    `update_by`   varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
    ...
    `remark`      varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '步数历史表\r\n' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of walking_steps_history
-- ----------------------------
